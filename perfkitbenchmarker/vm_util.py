...
def IssueCommand(cmd, force_info_log=False, suppress_warning=True,
                 env=None, timeout=DEFAULT_TIMEOUT, input=None, is_shell=None):
...
def IssueRetryableCommand(cmd, env=None):
  ...
  #MUST VISIT VISHNU commented because of security-warning SecurityWarning:
  if retcode:
